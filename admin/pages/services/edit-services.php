                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-default">
                      ...
                      if(isset($_POST['submit'])){
                        ...
                        if($icon!="" ){
                            $query =" UPDATE services SET icon='$icon', title='$title',service_desc='$service_desc' WHERE id='$id'"; // variable
                            ...
                            if($result){
                                ...
                                ?>
                                <meta http-equiv="refresh" content=" 0 ; url = manage-services.php" />
            <?php
                            }
                            else {
                                ...
                                <!-- Bootstrap modal end -->
                                    ...
                                    <div class="col-md-6">
                                        <!-- /.form-group -->
                                            ...
                                            <label for="exampleInputText1" class="form-label">Icon
                                            </label>
                                            <input type="text" class="form-control" id="exampleInputText2"
                                                aria-describedby="textHelp" value="<?php  echo $data['icon']?>" name="icon">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                                ...
                                                <label for="exampleInputText1" class="form-label">Service Description
                                                </label>
                                                <input type="text" class="form-control" id="exampleInputText3"
                                                    aria-describedby="textHelp" value="<?php  echo $data['service_desc']?>" name="service_desc">
