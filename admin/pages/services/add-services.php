                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-default">
                      ...
                      if(isset($_POST['submit'])){
                        ...
                        if($img!="" && $title!=""){
                            $query ="INSERT INTO sliders ( icon, title, services_desc) VALUES ('$icon','$title','$services_desc')"; 
                                ...
                                <!-- Bootstrap modal end -->
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <!-- /.form-group -->
                                            ...
                                            <input type="text" class="form-control" id="exampleInputText2"
                                                aria-describedby="textHelp" value="" name="icon">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                                ...
                                                <label for="exampleInputText1" class="form-label">Services Description
                                                </label>
                                                <input type="text" class="form-control" id="exampleInputText3"
                                                    aria-describedby="textHelp" value="" name="services_desc">
