                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-default">
                      ...
                      if(isset($_GET['id'])){
                        ...
                        $query1= "SELECT * FROM navbars where id= $id";
                      ...
                      if(isset($_POST['submit'])){
                        ...
                        if($logo!="" ){
                            $query =" UPDATE navbars SET logo='$logo' WHERE id='$id'"; // variable
                            ...
                            if($result){
                                ...
                                ?>
                                <meta http-equiv="refresh" content=" 0 ; url = manage-navbar.php" />
            <?php
                            }
                            else {
                      ...
                      ?>
                            <form action="#" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="modal-dialog modal-m" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Choose Logo</h5>
                                ...
                                <div class="form-group col-12 mb-0">
                                    ...
                                    <div>
                                                <input id="imagebox" class="form-control" name="logo" type="text" value="<?php  echo $data['img']?>">
                                            </div>
                                </div>

                                <div class="input-group mb-3 col-12">
                                    <input id="sliderbox" type="text" class="form-control" name="logo" readonly>
