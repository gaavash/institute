                    ...
                    <div class="card card-default">
                      ...
                      if(isset($_POST['submit'])){
                        ...
                        if($title!="" && $about_desc!="" && $sub_title!="" && $img!="" && $sub_num!=""){
                            $query ="INSERT INTO abouts ( title, about_desc, sub_title ,img,sub_num) VALUES ('$title','$about_desc','$sub_title','$img','$sub_num')"; 
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="exampleInputText2"
                                                aria-describedby="textHelp" value="" name="about_desc">
                                        </div>
                                        <!-- /.form-group -->
                                    </div>
                                    <!-- /.col -->
                                        ...
                                        <div class="form-group">
                                            <div class="mb-3">
                                                <label for="exampleInputText1" class="form-label">Sub Number
                                                    ...
                                                    <input type="text" class="form-control" id="exampleInputText3"
                                                    aria-describedby="textHelp" value="" name="sub_num">
                                                </div>
                                            </div>
                                        </div>
                                        <!-- /.col -->
