                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-default">
                      ...
                      if(isset($_GET['id'])){
                        ...
                        $query1= "SELECT * FROM abouts where id= $id";
                      ...
                      if(isset($_POST['submit'])){
                        ...
                        if($title!="" && $about_desc!="" && $sub_title!="" && $img!="" && $sub_num!=""){
                            $query =" UPDATE abouts SET title='$title',about_desc='$about_desc', sub_title='$sub_title' , img='$img' , sub_num='$sub_num' WHERE id='$id'"; // variable
                            ...
                            if($result){
                                ...
                                ?>
                                <meta http-equiv="refresh" content=" 0 ; url = manage-about.php" />
            <?php
                            }
                            else {
                               ...
                               <form action="#" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <!-- /.form-group -->
                                        <div class="mb-3">
                                            <label for="exampleInputText1" class="form-label">About Description
                                            </label>
                                            <input type="text" class="form-control" id="exampleInputText2"
                                                aria-describedby="textHelp" value="<?php  echo $data['about_desc']?>" name="about_desc">
                                        </div>
                                        <!-- /.form-group -->
                                    </div>
                                    <!-- /.col -->
                                        ...
                                        <div class="form-group">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputText3"
                                                    aria-describedby="textHelp" value="<?php  echo $data['sub_title']?>" name="sub_title">
                                            </div>
                                        </div>
                                        <!-- /.col -->
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="mb-3">
                                                <label for="exampleInputText1" class="form-label">Sub Number
                                                    </label>
                                                    <input type="text" class="form-control" id="exampleInputText3"
                                                    aria-describedby="textHelp" value="<?php  echo $data['sub_num']?>" name="sub_num">
                                                </div>
                                            </div>
                                            <!-- /.col -->
                                        </div>
                                ...
                                <div class="form-group col-12 mb-0">
                                    ...
                                    <!-- <div>
                                                <input id="imagebox" class="form-control" name="img" type="text" value="<?php  echo $data['title']?>">
                                            </div> -->
                                </div>
