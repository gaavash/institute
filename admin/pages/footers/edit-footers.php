                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-default">
                      ...
                      if(isset($_GET['id'])){
                        ...
                        $query1= "SELECT * FROM footers where id= $id";
                      ...
                      if(isset($_POST['submit'])){
                        ...
                        if($twitter= $_POST['twitter'] && $desc=$_POST['desc']  && $facebook!="" && $instagram!=""){
                            $query =" UPDATE footers SET facebook='$facebook',instagram='$instagram' , twitter='$twitter' , gmail='$gmail' , desc='$desc' WHERE id='$id'"; // variable
                                        ...
                                        <div class="form-group">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputText3"
                                                    aria-describedby="textHelp" value="<?php  echo $data['twitter']?>" name="twitter">
                                            </div>
                                        </div>
                                        <!-- /.col -->
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputText3"
                                                    aria-describedby="textHelp" value="<?php  echo $data['desc']?>" name="desc">
                                            </div>
                                        </div>
                                        <!-- /.col -->
                                    </div>
