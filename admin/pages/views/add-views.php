                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-default">
                      ...
                      if(isset($_POST['submit'])){
                        ...
                        $title= $_POST['title'];
                        $img= $_POST['img'];
                        $view_desc= $_POST['view_desc'];
         
                        if($img!="" && $title!=""){
                            $query ="INSERT INTO views (img,  title, view_desc) VALUES ('$img','$title','$view_desc')"; 
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputText3"
                                                    aria-describedby="textHelp" value="" name="view_desc">
