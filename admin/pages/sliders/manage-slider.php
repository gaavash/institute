      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <a href="add-slider.php" class="btn btn-primary"> add home</a>
          </div>
          <div class="col-sm-6">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                 ...
                 <tr>
                     ...
                     <td>
                         <a href="edit-slider.php?id=<?php echo $data['id']; ?>" class=" btn btn-info"> Edit</a>
                         <a href="../../process/delete-slider.php?id=<?php echo $data['id']; ?>" class="btn btn-danger" onclick="return checkDelete()">
                             Delete</a>
                     </td>
                 </tr>
                 <?php
