                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-default">
                      ...
                      if(isset($_GET['id'])){
                        ...
                        $query1= "SELECT * FROM contactinfos where id= $id";
                      ...
                      if(isset($_POST['submit'])){
                        ...
                        if($location!="" && $email!=""&& $phone!=""){
                            $query =" UPDATE contactinfos SET email='$email',location='$location',phone='$phone' WHERE id='$id'"; // variable
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputText3"
                                                    aria-describedby="textHelp" value="<?php  echo $data['location']?>" name="location">
                                            </div>
                                        </div>
                                        <!-- /.col -->
                                    </div>
