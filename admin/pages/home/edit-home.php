                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-default">
                      ...
                      if(isset($_GET['id'])){
                        ...
                        $query1= "SELECT * FROM homes where id= $id";
                      ...
                      if(isset($_POST['submit'])){
                        ...
                        if($img!="" ){
                            $query =" UPDATE homes SET  sub_desc='$sub_desc',img='$img',sub_title='$sub_title',home_desc='$home_desc' WHERE id='$id'"; // variable
                            ...
                            if($result){
                                ...
                                ?>
                                <meta http-equiv="refresh" content=" 0 ; url = manage-home.php" />
            <?php
                            }
                            else {
                      ...
                      ?>
                            <form action="#" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="input-group mb-3 col-12">
                                    <input id="sliderbox" type="text" class="form-control" name="img" value="<?php  echo $data['img']?>" readonly>
                                    ...
                                    <div class="col-md-6">
                                        <!-- /.form-group -->
                                            ...
                                            <input type="text" class="form-control" id="exampleInputText2"
                                                aria-describedby="textHelp" value="<?php  echo $data['sub_desc']?>" name="sub_desc">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                                ...
                                                <label for="exampleInputText1" class="form-label">Home Description
                                                </label>
