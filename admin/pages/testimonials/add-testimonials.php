                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-default">
                      ...
                      if(isset($_POST['submit'])){
                        ...
                        if($name!="" && $statement!="" ){
                            $query ="INSERT INTO testimonials (  img, name, post, statement)
                             VALUES ('$img', '$name', '$post', '$statement')"; 
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputText3"
                                                    aria-describedby="textHelp" value="" name="post">
                                            </div>
                                        </div>
                                        <!-- /.col -->
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputText3"
                                                    aria-describedby="textHelp" value="" name="statement">
                                            </div>
                                        </div>
                                        <!-- /.col -->
                                    </div>
