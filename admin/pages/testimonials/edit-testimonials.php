                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-default">
                      ...
                      if(isset($_GET['id'])){
                        ...
                        $query1= "SELECT * FROM testimonials where id= $id";
                      ...
                      if(isset($_POST['submit'])){
                        ...
                        if($statement!="" && $test_desc!=""){
                            $query ="UPDATE testimonials SET statement='$statement', img='$img', name='$name', post='$post' WHERE id='$id'";
                            ...
                            if($result){
                                ...
                                ?>
                                <meta http-equiv="refresh" content=" 0 ; url = manage-testimonials.php" />
            <?php
                            }
                            else {
                            ...
                            <form action="#" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="input-group mb-3 col-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="mb-3">
                                                <label for="exampleInputText1" class="form-label">Statement
                                                </label>
                                                <input type="text" class="form-control" id="exampleInputText3"
                                                    aria-describedby="textHelp" value="<?php  echo $data['statement']?>" name="statement">
                                            </div>
                                        </div>
                                        <!-- /.col -->
                                    </div>
