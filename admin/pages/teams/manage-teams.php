    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Manage Teams</h1>
            <a href="add-teams.php" class="btn btn-primary"> add teams</a>
          </div>
          <div class="col-sm-6">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                 ...
                 $sql = "SELECT * FROM teams order by id DESC  LIMIT $start_from, $limit";  
                 ...
                 <tr>
                     ...
                     <td>
                         <a href="edit-teams.php?id=<?php echo $data['id']; ?>" class=" btn btn-info"> Edit</a>
                         <a href="../../process/delete-teams.php?id=<?php echo $data['id']; ?>" class="btn btn-danger" onclick="return checkDelete()">
                             Delete</a>
                     </td>
                 </tr>
                 <?php
