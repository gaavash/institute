                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-default">
                      ...
                      if(isset($_GET['id'])){
                        ...
                        $query1= "SELECT * FROM teams where id= $id";
                      ...
                      if(isset($_POST['submit'])){
                        ...
                        if( $instagram!="" && $img!="" && $post!="" && $facebook!="" && $name!=""){
                            $query =" UPDATE teams SET message='$message', gmail='$gmail',instagram='$instagram' ,img='$img',post='$post' , facebook='$facebook' , name='$name' WHERE id='$id'"; // variable
                            ...
                            if($result){
                                ...
                                ?>
                                <meta http-equiv="refresh" content=" 0 ; url = manage-teams.php" />
            <?php
                            }
                            else {
...
<?php
                                ...
                                <div class="form-group col-12 mb-0">
                                    ...
                                    <div>
                                                <input id="imagebox" class="form-control" name="img" type="text" value="<?php  echo $data['img']?>">
                                            </div>
                                </div>
                                ...
                                <div class="input-group mb-3 col-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="mb-3">
                                                <label for="exampleInputText1" class="form-label">Post
                                                </label>
                                                <input type="text" class="form-control" id="exampleInputText3"
                                                    aria-describedby="textHelp" value="<?php  echo $data['post']?>" name="post">
                                            </div>
                                        </div>
                                        <!-- /.col -->
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputText3"
                                                    aria-describedby="textHelp" value="<?php  echo $data['facebook']?>" name="facebook">
                                            </div>
                                        </div>
                                        <!-- /.col -->
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputText3"
                                                    aria-describedby="textHelp" value="<?php  echo $data['instagram']?>" name="instagram">
                                            </div>
                                        </div>
                                        <!-- /.col -->
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputText3"
                                                    aria-describedby="textHelp" value="<?php  echo $data['gmail']?>" name="gmail">
                                            </div>
                                        </div>
                                        <!-- /.col -->
                                    </div>
