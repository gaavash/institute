                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-default">
                      ...
                      if(isset($_POST['submit'])){
                        ...
                        if( $staff_desc!="" && $img!="" && $post!="" && $name!=""){
                            $query ="INSERT INTO teams (message,instagram, gmail, img ,post,name,facebook) VALUES ('$message','$instagram','$gmail','$img','$post','$name','$facebook')"; 
